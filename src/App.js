...
function App() {
  return (
    ...
    <img className="fixed top-0 left-0 w-screen h-screen opacity-80 z-[-2] object-cover" alt="Background image" src={MapBackground} />
    <div className="fixed top-0 left-0 w-screen h-screen opacity-[94%] bg-slate-950 z-[-1]"></div>
    <div className="h-screen -translate-y-5 md:translate-y-0 flex flex-col justify-center items-center space-y-8 p-5 md:p-0">
      <div>
